...
```
vendor/bin/phpunit tests/unit/Espo/Modules/Shop
```
...
```
vendor/bin/phpunit tests/integration/Espo/Modules/Shop
```
...
* `build`
* `site/build`
* `site/application/Espo/Modules/Shop`
* `site/tests/unit/Espo/Modules/Shop`
* `site/tests/integration/Espo/Modules/Shop`
